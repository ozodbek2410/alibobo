          ...
          <div className="space-y-3">
            ...
            {variant.options.map((option, optionIndex) => (
              <div key={optionIndex} className="grid grid-cols-1 md:grid-cols-5 gap-3 p-3 bg-gray-50 rounded-md">
                ...
                <div>
                  <label className="block text-xs font-medium text-gray-600 mb-1">Qo'shimcha Narx</label>
                  <input
                    type="number"
                    value={option.price}
            ...
            <div>
              ...
              <div className="mt-2 text-sm text-blue-700">
                <ul className="list-disc list-inside space-y-1">
                  ...
                  <li>Har bir qiymat uchun qo'shimcha narx belgilashingiz mumkin</li>
                  <li>Har bir variant uchun alohida zaxira miqdorini belgilang</li>
                  <li>Variant uchun maxsus rasm qo'shishingiz mumkin</li>
                </ul>
              </div>
            </div>
          </div>
